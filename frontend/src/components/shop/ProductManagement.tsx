...
const ProductManagement: React.FC = () => {
  ...
  const seedMockData = () => {
    if (!localStorage.getItem('_shop_mock_seeded')) {
      ...
      rejectionStore.save({ product_id: 105, rejected_at: new Date(Date.now() - 86400000).toISOString(), reason: 'Hình ảnh không rõ ràng, mô tả thiếu thông số kỹ thuật', violations: [{ label: 'Ảnh sản phẩm', note: 'Ảnh bị mờ, không thể hiện rõ sản phẩm', imageUrl: 'https://placehold.co/400x400/dbeafe/1d4ed8?text=ipad+pro+m2', imgMarkers: [{ x: 35, y: 45 }, { x: 70, y: 30 }] }, { label: 'Mô tả', note: 'Thiếu thông số RAM, dung lượng pin' }] })
  ...
  // ── load ──────────────────────────────────────────────────────
  const MOCK_PRODUCTS = [
    { product_id: 101, product_name: 'iPhone 15 Pro Max 256GB', shop_id: 1, price: '29000000', stock_quantity: 35, sales_count: 128, status: 'active',   image_urls: ['https://placehold.co/300x300/dbeafe/1d4ed8?text=iphone15+pro'], description: 'iPhone 15 Pro Max chip A17 Pro, camera 48MP, titanium frame' },
    { product_id: 102, product_name: 'Samsung Galaxy S24 Ultra', shop_id: 1, price: '26000000', stock_quantity: 22, sales_count: 87,  status: 'active',   image_urls: ['https://placehold.co/300x300/dbeafe/1d4ed8?text=samsung+s24'], description: 'Galaxy S24 Ultra bút S Pen, camera 200MP, AI Galaxy' },
    { product_id: 103, product_name: 'AirPods Pro (2nd Gen)',    shop_id: 1, price: '6500000',  stock_quantity: 60, sales_count: 214, status: 'active',   image_urls: ['https://placehold.co/300x300/dbeafe/1d4ed8?text=airpods+pro'], description: 'AirPods Pro 2 chống ồn ANC, chip H2, USB-C' },
    { product_id: 104, product_name: 'MacBook Air M3 13"',       shop_id: 1, price: '32000000', stock_quantity: 12, sales_count: 0,   status: 'approved', image_urls: ['https://placehold.co/300x300/dbeafe/1d4ed8?text=macbook+air+m3'], description: 'MacBook Air chip M3, 8GB RAM, 256GB SSD, màn 13.6"' },
    { product_id: 107, product_name: 'iPad Air M2 11"',           shop_id: 1, price: '18500000', stock_quantity: 20, sales_count: 0,   status: 'approved', image_urls: ['https://placehold.co/300x300/dbeafe/1d4ed8?text=ipad+air+m2'], description: 'iPad Air M2 chip M2, màn 11" Liquid Retina, USB-C' },
    { product_id: 108, product_name: 'Beats Studio Pro',          shop_id: 1, price: '8900000',  stock_quantity: 15, sales_count: 0,   status: 'pending',  image_urls: ['https://placehold.co/300x300/dbeafe/1d4ed8?text=beats+studio+pro'], description: 'Beats Studio Pro Over-Ear, ANC, USB-C, 40h pin' },
    { product_id: 105, product_name: 'iPad Pro 12.9" M2',         shop_id: 1, price: '24000000', stock_quantity: 8,  sales_count: 0,   status: 'rejected', image_urls: ['https://placehold.co/300x300/dbeafe/1d4ed8?text=ipad+pro+m2'], description: 'iPad Pro 12.9 chip M2, màn Liquid Retina XDR' },
    { product_id: 106, product_name: 'Apple Watch Series 9',      shop_id: 1, price: '10500000', stock_quantity: 18, sales_count: 0,   status: 'rejected', image_urls: ['https://placehold.co/300x300/dbeafe/1d4ed8?text=apple+watch+s9'], description: 'Apple Watch S9 chip S9, màn Always-On Retina' },
  ]
