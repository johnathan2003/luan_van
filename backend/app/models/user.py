...
class User(Base):
    ...
    status = Column(Enum("active", "inactive", "banned", native_enum=False), default="active", index=True)
...
class UserRole(Base):
    ...
    status = Column(Enum("active", "inactive", native_enum=False), default="active")
